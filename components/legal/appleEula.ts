// Apple's Licensed Application End User License Agreement, verbatim.
//
// Do not edit, reword, reformat or translate the text below. It is Apple's
// contract, reproduced as Apple requires; any change makes it something other
// than the agreement the user is bound by. Localisation of this page happens in
// the chrome around it (lib/legal/<locale>.ts -> eula), not here.
