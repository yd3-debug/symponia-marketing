...
export const fr: LegalDict = {
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        id: 'tokens',
        blocks: [
          { t: 'p', x: '**Séances offertes.** Les nouveaux utilisateurs reçoivent un nombre limité de séances gratuites, afin de pouvoir essayer Symponia avant de s’abonner.' },
          { t: 'p', x: '**Symponia Mensuel (£12.99 par mois).** L’abonnement donne droit à 350 séances de réflexion par mois calendaire. Une nouvelle dotation de 350 séances est attribuée à chaque reconduction ; les séances non utilisées ne sont pas reportées. Les réflexions quotidiennes sont gratuites et ne sont pas décomptées de vos séances.' },
  ...
  credits: {
    metaTitle: 'Tarifs',
    metaDesc: 'Tarifs Symponia : commencez avec des séances offertes, puis £12.99 par mois pour 350 séances de réflexion.',
    kicker: 'Tarifs',
    ...
    free: {
      k: 'Nouveaux venus',
      price: 'Gratuit',
      sub: 'Quelques séances offertes pour découvrir Symponia',
      body: 'Nommez vos sept archétypes animaux, recevez le portrait de votre constellation et essayez quelques séances de réflexion. Sans engagement.',
