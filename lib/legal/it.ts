...
export const it: LegalDict = {
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        id: 'tokens',
        blocks: [
          { t: 'p', x: '**Credito gratuito.** I nuovi utenti ricevono un credito gratuito limitato, per provare Symponia prima di abbonarsi.' },
          { t: 'p', x: '**Symponia Mensile (£12.99 al mese).** L’abbonamento comprende 350 sessioni di riflessione per mese solare. A ogni rinnovo viene concesso un nuovo credito di 350 sessioni; le sessioni non utilizzate non vengono riportate al periodo successivo. Le riflessioni quotidiane sono gratuite e non vengono scalate dalle Sue sessioni.' },
  ...
  credits: {
    metaTitle: 'Prezzi',
    metaDesc: 'Prezzi di Symponia: si inizia con un credito gratuito, poi £12.99 al mese per 350 sessioni di riflessione.',
    kicker: 'Prezzi',
    ...
    free: {
      k: 'Nuovi arrivi',
      price: 'Gratuito',
      sub: 'Un piccolo credito gratuito per esplorare Symponia',
      body: 'Nomini i Suoi sette archetipi animali, riceva il ritratto della Sua costellazione e provi qualche sessione di riflessione. Senza impegno.',
