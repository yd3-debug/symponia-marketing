...
export const pt: LegalDict = {
  terms: {
    ...
    sections: [
      ...
      {
        h: '7. Assinaturas, preços e renovação automática',
        id: 'tokens',
        blocks: [
          { t: 'p', x: '**Teste gratuito.** Novos assinantes recebem um **teste gratuito de 7 dias**. Se você não cancelar pelo menos 24 horas antes do fim do teste, ele se converte automaticamente em uma assinatura paga e seu ID Apple é cobrado. Você pode cancelar a qualquer momento durante o teste sem nenhuma cobrança.' },
          { t: 'p', x: '**Symponia Mensal (£19.99 por mês).** A assinatura oferece reflexão ilimitada, sujeita aos limites de uso justo da seção 9. A Apple define o preço de cada país e pode alterá-lo; vale o preço exibido na App Store no momento da compra.' },
          { t: 'p', x: '**Cobrança.** O pagamento é cobrado no seu ID Apple na confirmação da compra ou ao fim do teste gratuito. A assinatura é renovada automaticamente todo mês, a menos que a renovação automática seja desativada pelo menos 24 horas antes do fim do período atual. A cobrança ocorre nas 24 horas anteriores ao fim do período.' },
          { t: 'p', x: '**Gerenciar a assinatura.** Você pode gerenciar ou cancelar sua assinatura, e desativar a renovação automática, a qualquer momento nos ajustes do seu ID Apple. Excluir o aplicativo não cancela a assinatura.' },
          { t: 'p', x: 'Todas as compras são feitas pela Apple. Não processamos seus dados de pagamento e nunca vemos os dados do seu cartão.' },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          { t: 'p', x: '**Uso justo.** A Symponia é ilimitada para uso pessoal normal. Para proteger o serviço contra abuso automatizado, aplicamos um teto de uso justo de **250 mensagens por semana** e **60 mensagens em qualquer período de 5 horas**. Esses limites ficam muito acima do que a prática reflexiva exige, e a maioria das pessoas nunca chegará perto deles. Se você atingir um limite, ele é temporário e o acesso volta quando o período passa.' },
          { t: 'p', x: 'As reflexões diárias são separadas das suas conversas e não são descontadas desses limites.' },
        ...
        blocks: [
          { t: 'p', x: '**Informações que nos fornece durante a configuração inicial e a utilização:**' },
          {
            ...
            x: [
              ...
              'suas **respostas iniciais**: as perguntas que você responde antes de começar. Elas são armazenadas e usadas para moldar como a Symponia fala com você. Nunca são citadas de volta;',
              'seus **check-ins de humor**: uma nota de 1 a 5 que você pode registrar antes e depois de uma reflexão, usada apenas para mostrar a sua própria semana;',
              'suas **reflexões armazenadas**, mas somente se você ativar a memória. Ela vem desativada por padrão e, enquanto estiver desativada, nada do que você escreve fica armazenado em nossos servidores;',
  ...
  credits: {
    metaTitle: 'Preços',
    metaDesc: 'Preços da Symponia: 7 dias grátis e depois £19.99 por mês por reflexão ilimitada. Nada para contar, nada para racionar.',
    kicker: 'Preços',
    h1: 'Um preço. Sem contagem.',
    lead: 'Sete dias grátis. Depois, reflexão ilimitada, pelo tempo em que for útil para você.',
    free: {
      k: 'Teste gratuito',
      price: '7 dias',
      sub: 'Tudo, de graça, por uma semana',
      body: 'Dê nome aos seus sete arquétipos animais, conheça o sétimo e reflita quanto quiser. Cancele antes do fim do teste e você não será cobrado.',
    ...
    monthly: {
      ...
      k: 'Symponia Mensal',
      price: '£19.99',
      sub: 'por mês · reflexão ilimitada',
      bullets: [
        'Reflexão ilimitada em Arquétipos, Meu dia e Conversa',
        'Nenhuma sessão para contar, nenhum saldo para racionar',
        'Sua semana de humor: como você chegou, como saiu e a diferença',
        'Nove idiomas, escritos como se tivessem sido compostos em cada um',
        'Cancele quando quiser nos ajustes do ID Apple',
      ],
      cta: 'Disponível no aplicativo',
    },
    how: {
      h2: 'Como funciona',
      items: [
        { t: 'Sete dias, grátis', d: 'O teste é o produto inteiro, não uma amostra. Se você cancelar pelo menos 24 horas antes do fim, nunca será cobrado.' },
        { t: 'Depois renova todo mês', d: 'O pagamento é cobrado no seu ID Apple ao fim do teste e todo mês depois, a menos que a renovação seja desativada pelo menos 24 horas antes do fim do período.' },
        { t: 'Ilimitada, com um teto publicado', d: 'Ilimitada para uso pessoal normal. Contra abuso automatizado aplicamos um limite de 250 mensagens por semana e 60 em qualquer período de 5 horas. Quase ninguém chegará perto, e preferimos publicar o número a escondê-lo.' },
        { t: 'A Apple define o preço onde você mora', d: 'O preço acima é o do Reino Unido. A Apple define um preço por país e pode alterá-lo. A App Store mostra o seu antes da compra.' },
        { t: 'Cancele em dois toques', d: 'Gerencie ou cancele quando quiser nos ajustes do seu ID Apple. Excluir o aplicativo não cancela a assinatura.' },
      ],
    },
    contact: 'Dúvidas sobre assinatura ou cobrança? Escreva para [hello@symponia.io](mailto:hello@symponia.io). Veja nossos [Termos de Serviço](/terms) para o detalhe.',
  },
};
