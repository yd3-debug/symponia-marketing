...
export const en: Dict = {
  ...
  nav: { rel: 'Relationships', method: 'The method', memory: 'Memory', faq: 'FAQ', about: 'About' },
  hero: {
    eyebrow: 'Depth psychology. Not therapy.',
    l1: 'You have had this fight',
    l2: 'before. With someone else.',
    lead: 'Same argument, new face. Symponia is an AI companion for inner work. You name six animals that feel like you, and a seventh that makes your skin crawl. The seventh is the one you avoid, and it is usually the one running your relationships.',
    cta: 'See the method',
    proof: 'App Store rating, number of people, and one honest sentence from a psychotherapist or Jungian analyst.',
  },
  recog: {
    k: 'Recognition',
    h2: 'Which one of these is yours?',
    items: [
      'We have had this exact argument four times. Different words, same wound.',
      'I picked someone completely different. Six months in, it is the same relationship.',
      'The moment they get close, I find a reason to leave.',
      'I snapped at him in a voice I recognised. It was my mother’s.',
      'I can explain my attachment style in detail. I still cannot stop doing it.',
      'When they ask what I need, I go blank.',
    ],
  },
  mech: {
    k: 'Why it keeps happening',
    h2: 'Your partner is not the problem. They are the screen.',
    lead: 'The story you tell yourself about them is usually a story about you. Psychologists call it projection, and it is not a character flaw. It is an old survival strategy that outlived its usefulness. What you cannot stand in them is very often what you exiled in yourself.',
    stat: 'Gottman found that 69% of what couples fight about is never resolved. The couples who last are not the ones who solved it. They are the ones who finally understood what it was about.',
    note: 'Symponia only ever hears one side. Yours. That happens to be the only side you can change. This is not couples counselling. It is the work you bring to the couple.',
  },
  seven: {
    k: 'The seventh animal',
    h2: 'Six animals that feel like you. One that makes your skin crawl.',
    lead: 'Name six that belong to you. Then name the one that repels you. That seventh is the most important of all, because it holds what the other six cannot carry.',
    lead2: 'Each animal is read for its gift, its shadow, and the path between them. Symponia reads the whole set together, including how you love, protect, withhold and open. Nothing is assigned to you. This is a lens, not a label, and it will never tell you your spirit animal.',
  },
  attune: {
  ...
  answer: {
    k: 'The difference',
    h2: 'Most apps hand you a prompt, then leave you alone with it.',
    lead: 'Read the reviews of any shadow work app and the same sentence keeps appearing: and then nothing happened. Symponia meets whatever you bring at its full weight, and every reply lands on one thing that takes you a layer deeper. Sometimes a question. Sometimes an image you cannot put down.',
    chat: [
      { who: 's', t: 'the trait that irritates you most in others is usually the one you exiled in yourself. what is it, in her?' },
      { who: 'u', t: 'she is so needy. it makes me want to run.' },
      { who: 's', t: 'and if neediness were allowed in you, what would it be asking for?' },
      { who: 'u', t: 'to be looked after, i suppose. i have never let anyone do that.' },
      { who: 's', t: 'then the thing you flee in her is the thing you have never permitted yourself. you have been standing at the edge of your own water for years, waiting to be invited in.' },
    ],
  },
  mem: {
    k: 'Memory',
  ...
  faq: {
    ...
    h2: 'FAQ',
    items: [
      { q: 'Can inner work really change my relationships?', a: 'Often, yes. You cannot make your partner do the work. But most of what you react to in them is something you have not looked at in yourself, and that part is yours to move.' },
      { q: 'What is projection, in plain English?', a: 'Reacting to the person in front of you based on an older story. The screen is your partner. The film is yours. Symponia helps you notice which is which.' },
      { q: 'Why do I keep choosing the same kind of person?', a: 'Because familiar and safe are not the same thing. Your nervous system moves toward what it recognises. Naming the pattern is what loosens its grip.' },
      { q: 'Is this therapy or couples counselling?', a: 'No. Symponia is a reflective tool. It only ever hears your side. If you are in crisis or need clinical support, please speak to a qualified professional.' },
      { q: 'Are the animals just a personality quiz?', a: 'No. Nothing is assigned to you. You choose seven, including one that repels you, and Symponia reads them together as a field. It will not tell you who you are.' },
      ...
      { q: 'Can I write in my own language?', a: 'Yes. Write in any language and Symponia understands and replies in kind.' },
    ],
  },
